import { Response } from '@typedefs/types'

type RestMethod = 'POST' | 'GET' | 'DELETE'

const ENDPOINT=  'https://webservices.sagebridge.org'
const SYNAPSE_ENDPOINT=  'https://repo-prod.prod.sagebase.org'
